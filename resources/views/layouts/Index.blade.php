...
<head>
    <meta charset="UTF-8">
    <meta name="Description" content="Welcome To Maktaba">
    <meta name="Viewport" content="width=device-width, initial-scale = 1.0">
    <title> المكتبة | الرئيسية </title>

    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css"
        integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <link rel="Stylesheet" href="{{asset('dist/css/main.css')}}" type="text/css" />
    <link rel="Stylesheet" href="{{asset('dist/dashborad/JM.css')}}" type="text/css" />
...
<body>
    <nav class="navbar-bottom navbar">
        ...
        <form class="searchbar">
            ...
            <input type="search" name="" placeholder="ابحث في المكتبة">
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
    <script src="{{asset('dist/dashborad/main.js')}}"></script>
